...
class BanAnAdapter(var context: Context, var layout: Int, var banAnList: List<BanAn>) :
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (view == null) {
            ...
            viewHolder!!.buttonDatBan=view.findViewById(R.id.button_dat_ban)
        ...
        if (kttinhtrang == "true") {
            ...
            viewHolder!!.buttonDatBan!!.visibility=View.GONE
        } else {
            viewHolder!!.imgBanAn!!.setImageResource(R.drawable.ghe1)
            viewHolder!!.buttonDatBan!!.visibility=View.VISIBLE
        }
        ...
        viewHolder!!.buttonDatBan!!.setOnClickListener(this)
        return view!!
    }
    ...
    override fun onClick(v: View) {
        ...
        when (id) {
            R.id.button_dat_ban->{
                isClick=if (!isClick){
                    viewHolder!!.imgBanAn!!.setImageResource(R.drawable.ghe11)
                    viewHolder!!.buttonDatBan!!.text = "Hủy đặt bàn"
                    true
                }else{
                    viewHolder!!.imgBanAn!!.setImageResource(R.drawable.ghe1)
                    viewHolder!!.buttonDatBan!!.text = "Đặt bàn"
                    false
                }
            }
